...
INSERT INTO `artist` VALUES (3,'Дубовик Юрій Іванович'),(4,'Самойлов Петро Андрійович'),(5,'Гак Марина Миколаївна'),(6,'Моршин Катерина Петрівна'),(7,'Ступка Богдан Богданович'),(8,'Антимійчук Микола Павлович'),(9,'Блажчук Максим Олександрович'),(10,'Бордюжан Борис Борисович'),(12,'Дашкевич Каріна Андріївна'),(13,'Блажчук Павло Олександрович'),(38,'П\'яний Шрек Шрекович'),(49,'Жопкін Подвійне-Ім\'ячко Шрекович'),(50,'Жопкін-Попкін Василь Іванович');
...
INSERT INTO `artist_and_genre` VALUES (3,'Драма'),(3,'Комедія'),(4,'Драма'),(5,'Драма'),(5,'Комедія'),(5,'Мелодрама'),(6,'Квартет'),(7,'Драма'),(7,'Комедія'),(7,'Мелодрама'),(7,'Мюзикл'),(8,'Пейзаж'),(9,'Мюзикл'),(9,'Пародія'),(10,'Драма'),(12,'Пейзаж'),(12,'Портрет'),(12,'Скульптура'),(13,'Драма'),(38,'Драма'),(38,'Комедія'),(38,'Мелодрама'),(49,'Скульптура'),(50,'Боєвик'),(50,'Фентезі');
...
INSERT INTO `artist_and_impresario` VALUES (5,1),(6,1),(7,2),(7,3),(8,8),(9,3),(10,8),(3,1),(13,3),(13,4),(13,1);
...
INSERT INTO `cinema_movie` VALUES (1,'Перший фільм','Фентезі',3,'2018-04-04'),(2,'Другий фільм','Комедія',2,'2018-05-04'),(3,'Третій фільм','Боєвик',3,'2018-03-04'),(4,'Четвертий фільм','Фантастика',4,'2018-02-18'),(5,'П\'ятий фільм','Детектив',5,'2018-02-21'),(6,'Шостий фільм','Тріллер',6,'2018-02-25'),(7,'Сьомий фільм','Детектив',7,'2018-02-23'),(8,'Восьмий фільм','Фантастика',8,'2018-02-27'),(9,'Дев\'ятий фільм','Комедія',9,'2018-02-10'),(10,'Десятфівий фільм','Боєвик',10,'2018-02-15'),(12,'фівфів','Драма',6,'2018-01-18'),(13,'фівf','Боєвик',1,'2018-01-02');
...
INSERT INTO `impresario` VALUES (1,'Бабенко Петро Михайлович'),(2,'Димитрук Світлана Вікторівна'),(3,'Ягоненко Микола Іванович'),(4,'Дрінь Ярослав Михайлович'),(5,'Столяр Іван Андрійович'),(6,'Мур Дмитро Павлович'),(7,'Стус Василь Семенович'),(8,'Шевченко Ярослав Степанович'),(9,'Шевчук Надія Іванівна'),(10,'Степаненко Степан Степанович'),(11,'Дмитренко Дмитро Дмитрович'),(12,'Сковорода Олександр Максимович'),(13,'Як Андрій Павлович');
...
INSERT INTO `organizer` VALUES (1,'Нестійко Марина Василівна'),(2,'Марик Степан Васильович'),(3,'Гринюк Денис Денисович'),(4,'Деранчук Станіслав Ігоревич'),(5,'Ігорчук Ігор Ігоревич'),(6,'Стопанко Андрій Андрійович'),(7,'Павленко Степан Павлович'),(8,'Блунчук Лариса Іванівна'),(9,'Торба Олексій Валентинович'),(10,'Жаба Микола Андрійович'),(11,'Санта Марія Григоріївна'),(12,'Дмитриченко Ксенія Леонідівна'),(13,'Дунай Григорій Васильович'),(14,'Мельничук Євген Євгенійович');
...
-- Dump completed on 2018-05-28 16:19:19
